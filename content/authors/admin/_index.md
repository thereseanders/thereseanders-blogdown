...
I am a data scientist at Apple, where I develop R software and [Shiny](https://shiny.rstudio.com/) applications to model global network and server demand. As an intern at [RStudio](https://www.rstudio.com), I contributed open-source software for peer review in data science courses via the [`ghclass`](https://rundel.github.io/ghclass/articles/peer.html) R package.
